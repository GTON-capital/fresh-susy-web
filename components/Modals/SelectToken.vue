    ...
    <div class="relative h-full w-full bg-white rounded-[18px] min-h-[300px] py-[34px] px-[20px] md:px-[70px] max-w-card">
      ...
      <div class="max-w-[480px] mx-auto">
        <div class="bg-[#F3F9F9] rounded-[8px] px-[20px] py-4 mb-[12px]">
          <div class="text-[13px] font-semibold mb-[10px]">
            Search name
          </div>
          <div class="relative">
        ...
        <div class="pb-4">
          <button v-for="(item, key) in items" :key="key" class="py-[6px] bg-transparent border-none flex items-center justify-start w-full text-left text-[14px] hover:font-bold hover:text-magenta" type="button"
