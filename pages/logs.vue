              ...
              >
                <span class="flex items-center min-h-[65px]">
                  ...
                  <template v-else>
                    ...
                    >
                      <img
                        class="w-[17px] h-[17px] object-center object-contain"
                        :src="item[col.withIcon]"
                        alt=""
                      />
                    </span>
                    <a
                      v-if="item[col.index] && col.type === 'copy'"
                    ...
                    >
                      {{ item[col.index]
                        ...
                        name="mono/copy"
                        class="ml-1 inline-block fill-current stroke-current"
                      />
                    </a>
...
export default Vue.extend({
  data: () => ({
    ...
    cols: [
      ...
      {
        label: 'Locking trx address',
        width: '110px',
        index: 'lockingAddress',
        type: 'copy',
      },
      {
        label: 'Minting trx address',
        width: '110px',
        index: 'mintingAddress',
        type: 'copy',
      },
      {
        label: 'Timestamp',
