  ...
  <div class="container">
    <div v-if="step === '1'"
      ...
      <div class="sm:bg-[#F3F9F9] sm:py-4 sm:px-5 sm:rounded-[8px] mt-[14px] sm:mt-4">
        <div class="sm:flex sm:flex-wrap sm:mx-[-9px]">
          ...
          <div class="mb-[5px] sm:mb-0 sm:w-[222px] sm:px-[9px]">
            ...
            <div
              class="ring-[#BDDBDF] ring-inset ring-1 w-full h-field bg-white rounded-[8px] py-[4px] px-[12px] flex items-center justify-start">
              <div
                class="rounded-full bg-white border-[#EAF1F3] border flex items-center justify-center mr-[6px] h-[32px] w-[32px] min-w-[32px]"
                style="box-shadow: 0 1px 25px #E2F1F6;">
                <img class="w-[18px] h-[18px] object-center object-contain" src="~/assets/img/icons/sol.svg" alt=""
                     width="30" height="30">
              </div>
              <div class="text-[14px]">
                Solana
          ...
          <div class="mb-[5px] sm:mb-0 sm:flex-initial sm:px-[9px] flex items-end justify-end">
            <div
              class="ring-[#BDDBDF] ring-inset ring-1 rounded-full w-[28px] h-[28px] sm:w-[42px] sm:h-field flex items-center justify-center bg-white">
              <icon name="mono/arrow-fold"
                    class="fill-current text-desaturated-cyan text-[12px] rotate-90 sm:rotate-0"/>
            </div>
          </div>
        ...
        <div class="mt-[14px] sm:flex sm:flex-wrap sm:mx-[-10px] sm:mt-4">
          ...
          <div class="mb-[14px] sm:mb-0 sm:flex-1 sm:px-[10px]">
            ...
            <div class="w-full relative">
              <input type="text" class="form-input w-full bg-[#F3F9F9] border-[#F3F9F9] pr-[50px]"
                     value="0x1015e2E...6AD26FB9" readonly>
              <img class="absolute -translate-y-1/2 top-1/2 right-[18px] w-[28px] h-[28px] object-contain object-center"
                   src="~/assets/img/icons/phantom.svg" alt="">
            </div>
          </div>
          ...
          <div class="mb-[14px] sm:mb-0 sm:w-[222px] sm:px-[10px]">
            <div class="flex items-center mb-[10px] text-[13px]">
              <div class="mr-auto font-semibold"
                   :class="{'opacity-50': !connectWallet}">Token
              </div>
              <div class="text-desaturated-cyan text-[11px]">Balance: {{ connectWallet ? '0.220955' : '0' }}</div>
            </div>
            <div class="w-full">
              <button type="button" class="form-select w-full text-left flex items-center justify-start"
                ...
                <span
                  ...
                  <img class="w-[18px] h-[18px] object-contain object-center" :src="item.img" alt="" width="30"
                       height="30">
                </span>
          ...
          <div class="sm:flex-1 sm:px-[10px]">
            <div class="mb-[10px] text-[13px]">
              <div class="font-semibold"
                   :class="{'opacity-50': !connectWallet}">Amount
              </div>
            </div>
            <div class="w-full relative">
      ...
      <button class="btn btn-solana2 btn-block mt-[34px]"
              :disabled="!connectWallet || Number.isNaN(Number(amount)) || Number(amount) <= 0"
              @click="step = '2'">
        Next
      </button>
    </div>
    <div v-if="step === '2'"
      ...
      <div class="sm:bg-[#F3F9F9] sm:rounded-[8px] sm:px-[30px] sm:py-[20px]">
        ...
        <div class="flex justify-center items-start mb-[24px] sm:mb-[20px]">
          <div class="flex flex-col items-center justify-start w-[60px]">
            <div
              class="border-[#EAF1F3] border rounded-full h-[32px] w-[32px] min-w-[32px] flex justify-center items-center bg-white"
              style="box-shadow: rgb(226, 241, 246) 0 1px 25px;">
        ...
        <div class="mb-[14px] sm:mb-[20px]">
          ...
          <div class="max-w-full whitespace-nowrap overflow-hidden text-[14px]">
        ...
        <div class="mb-[14px] sm:mb-[20px]">
          ...
          <div class="max-w-full">
            <input type="text" readonly class="form-input w-full sm:text-[20px] bg-[#E7F2F1] border-[#E7F2F1]"
                   :value="amount">
          </div>
        </div>
              ...
              <div class="form-input bg-[#E7F2F1] border-[#E7F2F1] w-full text-left flex items-center justify-start">
                <div
                  ...
                  <img class="w-[18px] h-[18px] object-contain object-center"
                       ...
                       width="30"
                       height="30">
                  <img class="absolute z-[1] left-1/2 top-0 w-[18px] h-[18px] object-contain object-center" src="~/assets/img/icons/susy.svg" alt=""
                       width="30"
                       height="30"
      ...
      <div class="text-center mt-[20px]">
        <button type="button" class="inline-block underline hover:no-underline text-magenta text-[14px] font-bold"
                @click="step = '1'">
          Back
        </button>
      </div>
