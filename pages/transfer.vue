<template>
  <div class="container">
    <div
      ...
      class="
        rounded-[18px]
        border-[#EAF1F3] border
        bg-white
        px-[20px]
        sm:px-[40px]
        md:px-[70px]
        py-[18px]
        sm:pt-[38px] sm:pb-[60px]
        max-w-card
        mx-auto
      "
    ...
    >
        ...
        <div class="sm:flex sm:flex-wrap sm:mx-[-9px]">
          <div class="mb-[5px] sm:mb-0 sm:w-[222px] sm:px-[9px]">
            ...
            >
              ...
              >
                <img
                  class="w-[18px] h-[18px] object-center object-contain"
          ...
          <div
            class="
              mb-[5px]
              sm:mb-0 sm:flex-initial sm:px-[9px]
              flex
              items-end
              justify-end
            "
          >
            ...
            >
              <icon
                name="mono/arrow-fold"
                class="
                  fill-current
                  text-desaturated-cyan text-[12px]
                  rotate-90
                  sm:rotate-0
                "
              />
          ...
          <div class="sm:flex-1 sm:px-[9px]">
            ...
            >
              ...
              >
                <img
                  class="w-[18px] h-[18px] object-center object-contain"
                  src="~/assets/img/icons/poligon.svg"
                  alt=""
                  width="30"
                  height="30"
                />
      ...
      <template v-if="connectWallet">
        ...
        <div class="mt-[14px] sm:mt-4">
          <button
            class="
              btn btn-outline-solana2 btn-block
              sm:h-auto sm:w-auto sm:inline-block
              underline
              hover:no-underline
              sm:leading-none sm:bg-none sm:hover:text-magenta
            "
      ...
      <template v-else>
        <button
          class="btn btn-outline-solana2 btn-block mt-4"
          ...
          <div class="mb-[14px] sm:mb-0 sm:w-[222px] sm:px-[10px]">
            <div class="flex items-center mb-[10px] text-[13px]">
              <div
                ...
                :class="{ 'opacity-50': !connectWallet }"
              >
                Token
              </div>
              <div class="text-desaturated-cyan text-[11px]">
                Balance: {{ connectWallet ? '0.220955' : '0' }}
              </div>
            </div>
            <div class="w-full">
              <button
              ...
              >
                ...
                >
                  <img
                    class="w-[18px] h-[18px] object-contain object-center"
                    :src="item.img"
                    alt=""
                    width="30"
                    height="30"
      ...
      <button
        class="btn btn-solana2 btn-block mt-[34px]"
        :disabled="
          !connectWallet || Number.isNaN(Number(amount)) || Number(amount) <= 0
        "
        @click="step = '2'"
      >
        Next
    ...
    >
      ...
      <div class="sm:bg-[#F3F9F9] sm:rounded-[8px] sm:px-[30px] sm:py-[20px]">
        ...
        <div
          class="mb-[24px] bg-[#E4EDEF] h-[1px] w-full hidden sm:block"
        ></div>
      ...
      <button
        class="btn btn-solana2 btn-block mt-[24px]"
  ...
  methods: {
    handleTransfer() {
      ...
      const modal = JSON.parse(
        JSON.stringify(this.$store.getters['app/exampleModals'].transaction)
      )
      ...
      setTimeout(() => {
        ...
        data.step1 = true
        this.$store.commit('app/SET_DATA_MODAL', {
          name: modal.name,
          index: modal.index,
          data,
        })
    ...
    handleSelectToken() {
      // Deep copy object
      const modal = JSON.parse(
        JSON.stringify(this.$store.getters['app/exampleModals'].selectToken)
      )
