...
export const WORMHOLE_RPC_HOSTS =
  CLUSTER === 'mainnet'
    ? ['https://wormhole-v2-mainnet-api.certus.one', 'https://wormhole.inotel.ro']
    : CLUSTER === 'testnet'
    ? ['https://wormhole-v2-testnet-api.certus.one']
    : ['http://localhost:8080']
export const ETH_NETWORK_CHAIN_ID = CLUSTER === 'mainnet' ? 1 : CLUSTER === 'testnet' ? 5 : 1337
export const SOLANA_HOST = CLUSTER === 'mainnet' ? clusterApiUrl('mainnet-beta') : CLUSTER === 'testnet' ? clusterApiUrl('testnet') : 'http://localhost:8899'
...
export const ETH_BRIDGE_ADDRESS = getAddress(
  CLUSTER === 'mainnet' ? '0x98f3c9e6E3fAce36bAAd05FE09d375Ef1464288B' : CLUSTER === 'testnet' ? '0x44F3e7c20850B3B5f3031114726A9240911D912a' : '0xC89Ce4735882C9F0f0FE26686c53074E09B0D550'
)
...
export const ETH_TOKEN_BRIDGE_ADDRESS = getAddress(
  CLUSTER === 'mainnet' ? '0x3ee18B2214AFF97000D974cf647E7C347E8fa585' : CLUSTER === 'testnet' ? '0xa6CDAddA6e4B6704705b065E01E52e2486c0FBf6' : '0x0290FB167208Af455bB137780163b7B7a9a10C16'
)
...
export const TERRA_BRIDGE_ADDRESS = 'terra18vd8fpwxzck93qlwghaj6arh4p7c5n896xzem5'
export const TERRA_TOKEN_BRIDGE_ADDRESS = 'terra10pyejy66429refv3g35g2t7am0was7ya7kz2a4'
...
export const COVALENT_GET_TOKENS_URL = (chainId: ChainId, walletAddress: string, nft?: boolean) => {
  let chainNum = ''
  if (chainId === CHAIN_ID_ETH) {
    chainNum = COVALENT_ETHEREUM_MAINNET
  }
  // https://www.covalenthq.com/docs/api/#get-/v1/{chain_id}/address/{address}/balances_v2/
  return `https://api.covalenthq.com/v1/${chainNum}/address/${walletAddress}/balances_v2/?key=${COVALENT_API_KEY}${nft ? '&nft=true' : ''}`
}

export const WETH_ADDRESS = CLUSTER === 'mainnet' ? '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2' : CLUSTER === 'testnet' ? '' : '0xDDb64fE46a91D46ee29420539FC25FD07c5FEa3E'
export const WETH_DECIMALS = 18

export const WORMHOLE_V1_ETH_ADDRESS =
  CLUSTER === 'mainnet' ? '0xf92cD566Ea4864356C5491c177A430C222d7e678' : CLUSTER === 'testnet' ? '0xdae0Cba01eFc4bfEc1F7Fece73Fe8b8d2Eda65B0' : '0xf92cD566Ea4864356C5491c177A430C222d7e678' //TODO something that doesn't explode in localhost
export const WORMHOLE_V1_SOLANA_ADDRESS = CLUSTER === 'mainnet' ? 'WormT3McKhFJ2RkiGpdw9GKvNCrB2aB54gb2uV9MfQC' : CLUSTER === 'testnet' ? 'BrdgiFmZN3BKkcY3danbPYyxPKwb8RhQzpM2VY5L97ED' : ''

export const TERRA_TOKEN_METADATA_URL = 'https://assets.terra.money/cw20/tokens.json'

export const WORMHOLE_V1_MINT_AUTHORITY = CLUSTER === 'mainnet' ? '9zyPU1mjgzaVyQsYwKJJ7AhVz5bgx5uc1NPABvAcUXsT' : CLUSTER === 'testnet' ? 'BJa7dq3bRP216zaTdw4cdcV71WkPc1HXvmnGeFVDi5DC' : ''
...
export const MIGRATION_PROGRAM_ADDRESS = CLUSTER === 'mainnet' ? 'whmRZnmyxdr2TkHXcZoFdtvNYRLQ5Jtbkf6ZbGkJjdk' : CLUSTER === 'testnet' ? '' : 'Ex9bCdVMSfx7EzB3pgSi2R4UHwJAXvTw18rBQm5YQ8gK'
